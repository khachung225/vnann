...
using CommodityPredictor.Properties;
using ZedGraph;

namespace CommodityPredictor
{
    public partial class WinMarketPredictor : Form
    {
        ...
        private string _pathToCommodity = "KCZ13_718.csv"; //SBN13_615
        ...
        /// </summary>
        private readonly DateTime _predictFrom = CSVReader.ParseDate("2013-07-01");// CSVReader.ParseDate("2013-07-01");

        /// <summary>
        /// Predict the percentage movement to a specific date
        /// </summary>
        private readonly DateTime _predictTo = CSVReader.ParseDate("2013-11-28");//CSVReader.ParseDate("2013-11-16");
